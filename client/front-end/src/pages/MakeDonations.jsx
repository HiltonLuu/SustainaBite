                    ...
                    <div key={index} className="card card-compact w-96 bg-base-100 shadow-xl p-0">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <button className="btn btn-secondary" onClick={() => document.getElementById('my_modal_3').showModal()}>
                                    ...
                                    <div className="modal-box max-w-2xl">
                                        ...
                                        <div className="flex m-10 no-flex">
                                            <div className="flex-1 align-top">
                                                <figure className=""><img className="rounded object-contain" src={company.company_img} /></figure>
                                                <p>{company.about}</p>
                                            </div>
                                            <div className="flex-1 align-top p-4 items-center">
